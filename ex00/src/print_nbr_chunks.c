...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2024/11/03 20:33:13 by aluis             #+#    #+#             */
/*   Updated: 2024/11/03 20:33:20 by aluis            ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "ft_header.h"

// Função para imprimir a potência de mil
// associada ao tamanho do array de partes do número.
...
// Função para imprimir a parte das centenas de um número.
...
// Função para imprimir a parte das dezenas de um número.
...
// Função para imprimir uma parte de três algarismos do número por extenso.
